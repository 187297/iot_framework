 ...
 * </p>
 * <ul>
 *   <li>{@link com.pfc.iot.impl.SoftwareImpl#getItem <em>Item</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SoftwareImpl extends ComponentImpl implements Software {
	/**
	...
	protected EClass eStaticClass() {
		return IotPackage.Literals.SOFTWARE;
	}
	...
	public EList<Item> getItem() {
		if (item == null) {
			item = new EObjectContainmentEList<Item>(Item.class, this, IotPackage.SOFTWARE__ITEM);
		}
		return item;
	}
